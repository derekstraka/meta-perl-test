...
METAPERLTEST_URI="."
METAPERLTEST_PATH="poky/meta-perl-test"
...
rm -rf "${METAPERLTEST_PATH}" || die "unable to clear old ${METAPERLTEST_PATH}"
ln -sf "../${METAPERLTEST_URI}" "${METAPERLTEST_PATH}" || \
	die "unable to symlink ${METAPERLTEST_PATH}"
